...
#	set_property IOSTANDARD LVCMOS33 [get_ports {sel}]
	#for fxn properties
set_property PACKAGE_PIN U1 [get_ports {f[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {f[0]}]
set_property PACKAGE_PIN T1 [get_ports {f[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {f[1]}]
set_property PACKAGE_PIN R2 [get_ports {f[2]}]					
...
set_property PACKAGE_PIN U14 [get_ports {overflow}]					
	...
	#for c_out
set_property PACKAGE_PIN V14 [get_ports {c_out}]					
