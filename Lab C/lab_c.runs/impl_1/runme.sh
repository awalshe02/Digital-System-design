...
HD_PWD='S:/digital system design/Lab_c/Lab_c/lab_c.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log six_bit_ripple_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source six_bit_ripple_adder.tcl -notrace
