...
HD_PWD='S:/digital system design/Lab_c/Lab_c/lab_c.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log six_bit_ripple_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source six_bit_ripple_adder.tcl
